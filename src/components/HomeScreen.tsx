...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  const selectedCategoryName = selectedCategoryObj ? t(`categories.${selectedCategoryObj.id}`, { defaultValue: selectedCategoryObj.name }) : '';
      ...
      <div className="flex items-center justify-between pt-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2.5 rounded-2xl bg-slate-200/70 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-300 dark:hover:bg-slate-700 transition shadow-sm active:scale-95"
            aria-label="Settings"
          >
          ...
          {activeCategories.map((cat: Category) => {
            ...
            return (
              <button
                ...
                className={`p-3.5 rounded-2xl text-left border transition-all duration-200 flex flex-col justify-between relative overflow-hidden ${
                  isSelected
      ...
      <div className="flex flex-col gap-3 pt-2">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <button
            ...
            className="p-3 bg-slate-100 dark:bg-slate-800/50 border border-dashed border-slate-300 dark:border-slate-700 rounded-2xl flex items-center gap-2.5 text-left hover:border-amber-400/60 transition group"
          >
        ...
        {selectedCategoryObj && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={onStartQuiz}
              className="w-full max-w-md py-4 px-6 rounded-2xl bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-slate-950 font-bold text-base shadow-lg shadow-amber-500/25 flex items-center justify-between border border-amber-300/60 group overflow-hidden"
            >
